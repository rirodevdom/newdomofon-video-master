...
# Обновляет установленный NewDomofon Video Master только файлами из
...
usage() {
  cat <<'EOF'
Безопасное обновление NewDomofon Video Master из текущей распакованной папки.
...
echo
echo "MASTER ОБНОВЛЁН ИЗ РАСПАКОВАННОГО АРХИВА"
